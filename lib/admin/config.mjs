...
export function loadConfig() {
  ...
  return Object.freeze({
    ...
    vkFeedStore: resolve(process.env.ANESTET_VK_FEED_STORE?.trim() || "/var/lib/anestet/vk-feed.json"),
    connectorSecretsStore: resolve(process.env.ANESTET_CONNECTOR_SECRETS_STORE?.trim() || "/var/lib/anestet/connector-secrets.enc.json"),
    connectorSecretsKey: process.env.ANESTET_CONNECTOR_SECRETS_KEY?.trim() || "",
