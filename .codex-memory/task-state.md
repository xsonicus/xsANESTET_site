...
- В v13.4.0 карточка представлена как компактное formula-досье: формат, сценарий и статус видны до раскрытия разделов; однократный scan и каскад появления заканчиваются после открытия и отключаются при reduced-motion.
