...
- `npm run qa:packshots` validates master/card/2000×2000 detail dimensions, true transparency, antialiased alpha, detail weight and zero RGB drift for every reconstructed silhouette.
