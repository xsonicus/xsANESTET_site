...
const SITE_RELEASE = "2026.09.02-v13.4.0";
...
const productCardPackshot = (product: Product) => product.image.includes("-alpha-restored-v3.webp")
  ? product.image.replace(/-alpha-restored-v3\.webp$/, "-card-v3.webp")
        ...
        {openProduct && openProductDetails && (
          <article className="product-detail-panel" key={openProduct.id}>
            ...
            <div className="product-detail-visual">
              ...
              <span className="product-detail-scan" aria-hidden="true" />
